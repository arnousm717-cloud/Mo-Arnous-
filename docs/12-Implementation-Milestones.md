...
**Phase 2 — CRM**: 2.1 Companies & Contacts · 2.2 Deals & Pipelines (kanban) · 2.3 Activities/Notes/Tags · 2.4 Agency Roll-Up Views · 2.5 Core API Conventions Applied Platform-Wide (pagination, idempotency, error envelope)
